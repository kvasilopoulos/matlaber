# Getting help with matlaber

Thanks for using matlaber. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/matlaber/issues) to make sure the 
